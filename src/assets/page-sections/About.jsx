...
function About() {
  return (
    <main className='max-w-[1600px] mx-auto h-full p-5'>
        <section className='relative w-full h-full border border-red-500'>
            ...
            alt="about"
            className='w-screen'/>
            <section className='top-[75%] left-0 bg-[#f9d94e] xl:w-[50%] xl:absolute p-5 xl:p-[5em]'>
            ...
            <section className='xl:absolute xl:top-[100%] xl:right-0 xl:w-[45%] xl:text-2xl font-extralight p-5 xl:p-10'>
