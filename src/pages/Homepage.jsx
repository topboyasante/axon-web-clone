...
function Homepage() {
  return (
    <main className='pt-[12vh]'>
        {/* Hero Section */}
        <section className='max-w-[1600px] h-full mx-auto flex flex-col justify-center p-5'>
            <main className='flex md:flex-col md:gap-5 lg:flex-row justify-around items-center'>
               {/* Text Area */}
                ...
                {/* Form */}
                <section className='bg-[#1b5488] lg:w-[35%] h-[50vh] lg:h-[80vh] shadow-5xl p-5 hidden lg:block'>
                  <h1 className='text-[#f8a60a] text-4xl border w-[70%] font-extrabold'>
